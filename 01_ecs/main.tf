...
locals {
  ...
  alb_url               = data.terraform_remote_state.base.outputs.alb_url
  alb_target_group      = data.terraform_remote_state.base.outputs.alb_target_group
}
...
module "task_definitions" {
  ...
  ecr_commitflow_url         = "761018874759.dkr.ecr.eu-central-1.amazonaws.com/commitflow"
  ecr_commitflow_grafana_url = "761018874759.dkr.ecr.eu-central-1.amazonaws.com/commitflow/grafana"
}
